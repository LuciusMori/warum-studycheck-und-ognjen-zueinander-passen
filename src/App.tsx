              ...
              {[
                ...
                <div key={index} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem', backgroundColor: '#0a192f', borderRadius: '0.5rem', border: '1px solid #475569' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <div style={{ width: '8rem', backgroundColor: '#475569', borderRadius: '9999px', height: '0.75rem' }}>
                      <div style={{ width: '100%', height: '0.75rem', backgroundColor: '#64ffda', borderRadius: '9999px' }}></div>
                    </div>
                    <span style={{ color: '#64ffda', fontWeight: '700', fontSize: '0.875rem' }}>100%</span>
                  </div>
                </div>
              ))}
            </div>
            <div style={{ textAlign: 'center', marginTop: '2rem' }}>
              <p style={{ color: '#64ffda', fontWeight: '700', fontSize: '1.25rem' }}>Perfekte Übereinstimmung!</p>
              <p style={{ color: '#94a3b8', marginTop: '0.5rem' }}>Alle Anforderungen werden voll erfüllt</p>
            </div>
          </div>
        </div>
      </section>
